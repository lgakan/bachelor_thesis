...
def test_simulate_eb_operations(balance: Union[float, List[float]], start_lvl: Union[float, None], expected_lvl: float, energy_bank: type(EnergyBank)) -> None:
    assert simulate_eb_operation(energy_bank(), balance, start_lvl) == expected_lvl


class TestDayAlgorithm:
    def test_basic_optimize_mixed_balances(self, energy_bank: type(EnergyBank), day_strategy: DayPredictionStrategy) -> None:
    ...
    def test_basic_optimize_positive_balances(self, energy_bank: type(EnergyBank), day_strategy: DayPredictionStrategy) -> None:
    ...
    def test_basic_mixed_prices_handler(self, energy_bank: type(EnergyBank), day_strategy: DayPredictionStrategy) -> None:
        prices = [127.69, -129.71, 40.53, 50.14, -150.79, 14.88]
        balances = [-0.08, -0.89, 0.45, 0.15, 0.18, 1.05]
        energy_bank = energy_bank()
    ...
    def test_basic_negative_prices_handler(self, energy_bank: type(EnergyBank), day_strategy: DayPredictionStrategy) -> None:
    ...
    def test_basic_positive_prices_handler(self, energy_bank: type(EnergyBank), day_strategy: DayPredictionStrategy) -> None:
        prices = [127.69, 129.71, 40.53, 150.79, 14.88]
        balances = [-1.2, -0.4, 3.45, 1.68, -0.05]
        energy_bank = energy_bank()
    ...
    def test_get_plan(self, start_en: float, prices: List[float], balances: List[float], expected_balances: List[float],
                      day_strategy: DayPredictionStrategy) -> None:
...
class TestNightAlgorithm:
    def test_basic_calculate_hourly_balances(self, energy_bank: type(EnergyBank), night_strategy: NightPredictionStrategy) -> None:
    ...
    def test_invalid_calculate_hourly_balances(self, idx_order: List[int], balances: List[float],
                                               energy_bank: type(EnergyBank), night_strategy: NightPredictionStrategy) -> None:
        with pytest.raises(Exception):
            energy_bank = energy_bank()
            night_strategy.calculate_hourly_balances(energy_bank, idx_order, balances, energy_bank.lvl)

    def test_basic_mixed_prices_handler(self, energy_bank: type(EnergyBank), night_strategy: NightPredictionStrategy) -> None:
        prices = [127.69, -129.71, 40.53, 50.14, -150.79, 14.88]
        balances = [-0.08, -0.89, 0.45, 0.15, 0.18, 1.05]
    ...
    def test_basic_positive_prices_handler(self, energy_bank: type(EnergyBank), night_strategy: NightPredictionStrategy) -> None:
        prices = [127.69, 129.71, 40.53, 150.79, 14.88]
    ...
    def test_get_plan(self, start_en: float, prices: List[float], balances: List[float], expected_balances: List[float],
                      night_strategy: NightPredictionStrategy) -> None:
