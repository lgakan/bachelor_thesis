...
def test_simulate_eb_operations(balance: Union[float, List[float]], start_lvl: Union[float, None], expected_lvl: float, energy_bank: EnergyBank):
    assert simulate_eb_operation(energy_bank, balance, start_lvl) == expected_lvl


class TestDayAlgorithm:
    def test_optimize_balances(self):
        pass

    def test_optimize_positive_balances(self):
        pass

    def test_mixed_prices_handler(self):
        pass

    def test_negative_prices_handler(self):
        pass

    def test_positive_prices_handler(self):
        pass
...
class TestNightAlgorithm:
    ...
    def test_invalid_calculate_hourly_balances(self, idx_order: List[int], balances: List[float],
                                               energy_bank: EnergyBank, night_strategy: NightPredictionStrategy):
        with pytest.raises(Exception):
            night_strategy.calculate_hourly_balances(energy_bank, idx_order, balances)

    def test_basic_mixed_prices_handler(self, energy_bank: EnergyBank, night_strategy: NightPredictionStrategy):
    ...
    def test_basic_positive_prices_handler(self, energy_bank: EnergyBank, night_strategy: NightPredictionStrategy):
